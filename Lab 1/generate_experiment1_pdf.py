...
im = ax.imshow(conf_mat, cmap='viridis')
for i in range(2):
    for j in range(2):
        ax.text(j, i, str(conf_mat[i, j]), ha='center', va='center', fontsize=12)
...
story.append(p(f'Using forged banknotes as the positive class: TN = {conf_mat[0,0]}, FP = {conf_mat[0,1]}, FN = {conf_mat[1,0]}, and TP = {conf_mat[1,1]}.'))
